...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('count', type=int, help='Indicates the number of tags to be created')
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f"Successfully created {count} fake tags in {duration:.2f} seconds"))
